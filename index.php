...
<body>
    <header class="mb-5">
        <div class="top-bar">
            <img src="google.com" alt="Google logo">
            <h3>Privacy e Termini</h3>
        </div>
        <nav>
            <ul class="list-ustyled d-flex">
                <li>Introduzione</li>
    ...
    <main>
        <div class="container">
            <?php
            foreach ($db_google as $article) {
                ?>
                <div class="article-privacy">
                <?php
                    echo "<". $article['title']['tag'] .">". $article['title']['textTitle'] ."</". $article['title']['tag'] .">";
                
                foreach ($article['paragraph'] as $par){
                    echo "<p>". $par ."</p>";
                }
                    ?>
